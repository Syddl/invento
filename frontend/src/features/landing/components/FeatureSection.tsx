    ...
    <section id="features" className="py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          {/* Feature 1 */}
          <div>
            <div className="inline-flex items-center justify-center w-12 h-12 bg-gray-900/10 rounded-lg mb-6">
          ...
          <div className="bg-gradient-to-br from-gray-100 to-gray-300 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:order-2">
            ...
            <h3 className="text-2xl font-bold text-text-gray-900 mb-4">
          ...
          <div className="lg:order-1 bg-gradient-to-br from-gray-100 to-gray-300 rounded-2xl p-8">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm font-medium text-gray-600">
